...
export default function Home() {
  return (
    ...
    <main className="bg-bg_color min-h-[98vh] text-text_color flex  justify-center items-center relative">
      <Image width={400} height={400} src={'/home/my_photo.jpeg'} alt="foto mikael" className="opacity-80 rounded-[0.5rem] left-[12%] top-[2%] w-[30vw]"  style={{ boxShadow: "#8821e7 -0.7rem 0.7rem 1px"}}></Image>
