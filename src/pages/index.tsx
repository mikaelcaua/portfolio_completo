...
//             {/* <Image width={250} height={200} src={'/home/my_photo.jpeg'} alt="foto mikael" className="opacity-80 rounded-[2rem] md:hidden "  style={{ boxShadow: "#20b7e0 -0.8rem 1rem 1px"}} unoptimized></Image> */}
//           </div>
